...
function main() {
    ...
    function moveElf(elf) {
        if (!elf.nextWantedPosition) return false;
    ...
    while (movingElves > 0) {
        ...
        turn++;
        console.log(`== TURN ${turn}, ${movingElves} elves move ==`);
    }
    ...
    resolving.succeed(`Jour ${chalk.red(23)} - the answer is ${chalk.bold.magenta(turn)}`);
